...
export const questions = [
  ...
  },
  {
    ...
    options: [
      ...
      "Consumir productos descartables",
      "Desperdiciar agua"
    ],
    answer: 0,
  ...
  },
  {
    ...
    options: [
      ...
      "Cantidad de agua en un lugar",
      "Número de árboles plantados",
      "Nivel de contaminación del aire"
    ],
    answer: 0,
    explanation: "La biodiversidad es la variedad de especies vivas en un ecosistema o en el planeta."
  }
];
